    ...
    <section id="como-trabalhamos" className="bg-white overflow-hidden">
      <style>{`
        ...
        @media (max-width: 1023px) {
          .como-atuamos-copy-wrap {
            justify-content: center;
          }

          .como-atuamos-copy-card {
            display: flex;
            justify-content: center;
            align-items: center;
      ...
      <div className="grid grid-cols-1 lg:grid-cols-[minmax(360px,0.9fr)_minmax(0,1.1fr)] 2xl:grid-cols-2 items-stretch">
        <div className="como-atuamos-copy-wrap flex justify-end">
          <div className="como-atuamos-copy-card w-full max-w-[680px] py-20 px-4 sm:px-6 lg:px-8 2xl:max-w-[768px]">
            ...
            <ul className="flex flex-col gap-4 mb-10 mx-auto sm:mx-0" style={{ maxWidth: '291px', width: '100%' }}>
              {items.map((item, i) => (
                <li key={i} className="como-atuamos-feature-item flex flex-col items-center text-center sm:flex-row sm:items-start sm:text-left gap-2 sm:gap-3">
